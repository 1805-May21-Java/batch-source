...
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(5, 3.56, 3, DATE '1990-02-01',  DATE '2018-02-02', 'Approved', 'wwww.twitter.com');   
    
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(6, 45.56, 3, DATE '1980-02-01',  DATE '2018-02-02', 'Approved', 'wwww.twitter.com');   
    
    
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(4, 71.56, 2, DATE '1987-02-01',  DATE '2018-02-02', 'Denied', 'wwww.twitter.com');   
    
    
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(3, 23.56, 3, DATE '1966-02-01',  DATE '2018-02-02', 'Approved', 'wwww.twitter.com');   
    
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(4, 83.56, 2, DATE '1949-02-01',  DATE '2018-02-02', 'Denied', 'wwww.twitter.com');   
    
    
INSERT INTO REIMBURSE(REQUEST_BY, AMOUNT, APPROVE_BY, DATE_REQUEST, DATE_APPROVE, STATUS, URL)
    VALUES(5, 93.56, 2, DATE '1982-02-01',  DATE '2018-02-02', 'Denied', 'wwww.twitter.com');   
