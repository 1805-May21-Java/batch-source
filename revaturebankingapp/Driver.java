...
//		Account a3 = new Account("CHECKING", 0.01, 3);
//		User u3 = new User("email99@99.com", "pass", "James", "Bond");
//		Session s = HibernateUtil.getSession();
//		
//		//User u2 = new User("test@email.com", "password", "Jack", "Bauer");
//		
//		//Account a2 = new Account("SAVINGS", 2.99, 42);
//		
//		Transaction tx = s.beginTransaction();
//		UserDAOImpl udi = new UserDAOImpl();
//		System.out.println(udi.getUserByEmail("email99@99.com"));
//		
//		
//		//s.save(u2);
//		//s.save(a2);
...
//		System.out.println("done");
		...
		//Depending on users choice, appropriate methods are called
			if (option == 1) {
				a1.viewAccounts(u2.getAccountid());
				System.out.println();
		} else if (option == 2) {
				a1.newAccount(u2);
				System.out.println();
