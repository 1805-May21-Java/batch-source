...
INSERT INTO ERS_REQUEST (EMPL_ID, AMOUNT, DESCRIPTION, STATUS, DATE_REQUESTED) VALUES (5, 200, 'Travel Expenses', 'PENDING', LOCALTIMESTAMP);
INSERT INTO ERS_REQUEST (EMPL_ID, AMOUNT, DESCRIPTION, STATUS, DATE_REQUESTED) VALUES (2, 400, 'I want it', 'PENDING', LOCALTIMESTAMP);
INSERT INTO ERS_REQUEST (EMPL_ID, AMOUNT, DESCRIPTION, STATUS, DATE_REQUESTED, DATE_RESOLVED) VALUES (2, 6, 'I got a sandwich', 'DENIED', LOCALTIMESTAMP, LOCALTIMESTAMP);
