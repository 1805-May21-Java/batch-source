...
public class User {
	...
	public User(int userId, String username, String email, String password, List<Long> linkedAccounts) {
		super();
		this.userId = userId;
	...
	public User(String username, String email, String password, List<Long> linkedAccounts) {
		super();
		this.username = username;
		this.email = email;
		this.password = password;
