...
public interface ReimbursementInterface {
	long createReimbursement(Connection connection, long reimbursementId, long employeeId, double reimbursementValue, long managerId, String reimbursementReason, int status) throws SQLException;
