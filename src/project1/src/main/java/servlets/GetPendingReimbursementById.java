...
/**
 * Servlet implementation class GetPendingReimbursementById
 */
public class GetPendingReimbursementById extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetPendingReimbursementById() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			reimbursementList = reimbursementDao.getPendingReimbursementByEmployeeId(ConnectionUtil.getConnection(), Long.parseLong(employeeId));
