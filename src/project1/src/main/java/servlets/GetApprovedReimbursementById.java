...
/**
 * Servlet implementation class GetApprovedReimbursementsById
 */
public class GetApprovedReimbursementById extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetApprovedReimbursementById() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			reimbursementList = reimbursementDao.getApprovedReimbursementByEmployeeId(ConnectionUtil.getConnection(), Long.parseLong(employeeId));
