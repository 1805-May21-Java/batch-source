...
/**
 * Servlet implementation class GetDeniedReimbursementsById
 */
public class GetDeniedReimbursementById extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetDeniedReimbursementById() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			reimbursementList = reimbursementDao.getDeniedReimbursementByEmployeeId(ConnectionUtil.getConnection(), Long.parseLong(employeeId));
